  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50 p-4">
      <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-3xl w-full max-w-sm shadow-2xl transform transition-all duration-500 scale-100 border border-white/20 dark:border-slate-700">
        {/* Header */}
        <div className="bg-blue-700 text-white p-6 rounded-t-3xl text-center relative overflow-hidden">
          ...
          {isLoginMode ? (
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    name="username"
                    required
                    className="w-full pl-4 pr-12 py-3 border-2 border-gray-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white/80 dark:bg-slate-800 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-slate-400 backdrop-blur-sm"
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-3 px-6 rounded-xl font-semibold hover:bg-blue-700 transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
              >
                {loading ? (
