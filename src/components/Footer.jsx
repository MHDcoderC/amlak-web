const Footer = () => {
  return (
    <footer className="bg-white shadow-custom-lg border-t border-gray-200 mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 mb-4 leading-relaxed">
              بهترین پلتفرم خرید و فروش املاک در ایران. با بیش از ۱۰ سال تجربه در زمینه املاک، 
          ...
          {/* Services */}
          <div>
            <h4 className="text-lg font-semibold text-gray-900 mb-4">خدمات ما</h4>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">
              © ۱۴۰۲ املاک ایران. تمامی حقوق محفوظ است.
            </p>
